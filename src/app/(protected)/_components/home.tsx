...
function Home() {
  ...
  const giverCards = [
    ...
    {
      title: 'Connect with Care Seekers',
      ...
      <div className="w-full flex flex-col items-center relative z-20 pt-[400px] pb-[150px]">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[32px] max-w-[1080px] w-full px-4">
          ...
          {activeCards.map((card, idx) => (
            <Link key={idx} href={card.link} className="flex flex-col gap-[12px] w-full max-w-[338.67px] h-auto md:h-[360px] mx-auto cursor-pointer group">
              <div className="flex flex-col items-center justify-center bg-white rounded-[12px] w-full h-[264px] shadow-sm group-hover:shadow-md transition">
          ...
          <div className="flex flex-col gap-[12px] w-full max-w-[338.67px] h-auto md:h-[360px] mx-auto">
            <div className="flex flex-col items-center justify-center bg-white rounded-[12px] w-full h-[264px] shadow-sm">
              <div className="flex flex-col items-center gap-[8px]">
